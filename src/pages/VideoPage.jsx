                        ...
                        <div className="flex flex-col gap-3 w-[80%] shadow-xl px-12 py-10 bg-slate-100">
                            ...
                            <div className="flex flex-col lg:flex-row gap-5 w-full">
                                ...
                                <div className="w-full flex flex-col justify-between gap-5">
                                    ...
                                    <motion.button className="bg-black w-fit text-white normal-case font-extralight px-3 py-2 rounded-md" whileHover={{ scale: 1.025, color: "goldenrod" }} transition={{ type: "spring", stiffness: 400, damping: 10 }}>
